...
class TopProductFilter extends Component implements HasForms
{
    ...
    public function render()
    {
        ...
        $datas = Product::query()
            ->with(['unit', 'subunit'])
            ->withSum(['orderitems as sold' => function ($query) use ($startOfMonth, $endOfMonth) {
        ...
        return view('livewire.top-product-filter', compact('datas'));
    }
}
