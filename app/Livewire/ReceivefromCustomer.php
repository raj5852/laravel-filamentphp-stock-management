...
class ReceiveFromCustomer extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table)
    {
        return $table
            ...
            ->heading(new HtmlString('<h2 style="font-size:23px; font-weight:bold">Receive from Customer</h2>'))
            ->columns([
                TextColumn::make('customer.customer_name')->label('Supplier Name'),
    ...
    {
        return view('livewire.receive-from-customer');
    }
}
