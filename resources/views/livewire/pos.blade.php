<div>
    <div class="grid gap-4 md:grid-cols-2">
        ...
        <div>
            <div class="space-y-2">
                <div
                    class="max-w p-3 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-900 dark:border-gray-700">
                    {{ $this->form }}
                            ...
                            <table
                                ...
                                <thead class="bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100">
                                    <tr>
                                        ...
                                        <th class="px-4 py-2 border dark:border-gray-700">Quantity</th>
                                        <th class="px-4 py-2 border dark:border-gray-700">Price</th>
                                        <th class="px-4 py-2 border dark:border-gray-700">Sub T</th>
                                ...
                                <tbody>
                                    @foreach ($this->products as $index => $product)
                                        <tr class="bg-white dark:bg-gray-900 ">
                                            <td class="px-4 py-2 border dark:border-gray-700">{{ $product['name'] }}
                                            </td>
                                            ...
                                            <td
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <div
                                                        class="{{ $product['unit_id'] === null ? 'w-full' : 'flex-1' }}">
                                                        <label
                                            ...
                                            <td class="px-4 py-2 border dark:border-gray-700 w-[80px]">
                                                <div class="flex items-center gap-2 ">
